        ...
        <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="<?php echo BASEURL; ?>assets/img/img_carrosel_1.png" class="d-block w-100 carrosel" alt="...">
            </div>
            <div class="carousel-item">
              <img src="<?php echo BASEURL; ?>assets/img/img_carrosel_2.png" class="d-block w-100 carrosel" alt="...">
            </div>
            <div class="carousel-item">
              <img src="<?php echo BASEURL; ?>assets/img/img_carrosel_3.png" class="d-block w-100 carrosel" alt="...">
            </div>
          </div>
    ...
    <div class="col-3 me-5">
      <div class="card cardser">
        ...
        <div class="card-body d-flex align-items-center justify-content-center">
          <h5 class="card-title text-center san cardtit">Festa no Espaço</h5>
        </div>
      </div>
    </div>
    <div class="col-3 me-5">
      <div class="card cardser">
        ...
        <div class="card-body d-flex align-items-center justify-content-center">
          <h5 class="card-title text-center san cardtit">Área Kids</h5>
        </div>
      </div>
    </div>
    <div class="col-3 me-5">
      <div class="card cardser">
        ...
        <div class="card-body d-flex align-items-center justify-content-center">
          <h5 class="card-title text-center san cardtit">Pronta Entrega</h5>
        </div>
      </div>
    </div>
  </div>
...
<div class="container mb-5 d-flex flex-column justify-content-center align-items center">
  ...
  <div class="row me-2">
    <div class="col-6">
      ...
      <div class="d-flex justify-content-center align-items-center fundotxt mt-4">
        <img src="<?php echo BASEURL; ?>assets/img/whatsapp.png" class="icone">
        <h1 class="tit me-4">(97)1234-5678</h1>
      </div>
      <div class="d-flex justify-content-center align-items-center fundotxt mt-4">
        <img src="<?php echo BASEURL; ?>assets/img/instagram.png" class="icone">
        <h1 class="tit me-5">xerife.pastell</h1>
      </div>
      <div class="d-flex justify-content-center align-items-center fundotxt mt-4">
        <img src="<?php echo BASEURL; ?>assets/img/facebook.png" class="icone">
        <h1 class="tit me-5">Xerife Pastell</h1>
      </div>
    </div>
