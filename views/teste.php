...
<div class="container">
    ...
    <section arial-label="Teste Tibetano 1">
        ...
        <div class="enum txtadivinha tit">
            ...
            <p class="font2">Queijo;</p>
            <p class="font2">Bauru;</p>
            <p class="font2">Camarão;</p>
            <p class="font2">Morango;</p>
            <p class="font2">Beijinho.</p>
            <p>Coloque esses pastéis na ordem que mais te agrada, do primeiro ao último. <span class="font2">NÃO PENSE DEMAIS.</span> Siga o seu instinto de xerife e escolha pela emoção do momento!</p>
